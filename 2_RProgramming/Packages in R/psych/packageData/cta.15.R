"cta.15" <- function(n=3,t=5000, cues = NULL, act=NULL, inhibit=NULL, consume = NULL,ten = NULL, type="both",fast=2 ) {
...
for (i in 1:t) {
 ...
 for (j in 2:n) {points(tendencies.m[j,],lty=j,col=colours[j],typ="l",lwd=2)}
  ...
  yl <- range(actions.m)
 plot(actions.m[1,],ylim=yl,xlab="time",ylab="Actions",col="black",typ="l",main="Actions over time",lwd=2)
