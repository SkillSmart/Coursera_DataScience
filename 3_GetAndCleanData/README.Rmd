...
- This document contains a short general overview of the topic (Annotated Coursenotes from Coursera Specialization)
- The main folder contains **R syntax for the most common application scenarios **
- In `./Packages-Syntax` i collected all relevant R packages and introduced the basic R code as syntax demonstration to implement the most important features
