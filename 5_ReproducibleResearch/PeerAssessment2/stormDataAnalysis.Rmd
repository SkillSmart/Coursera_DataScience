---
title: Analysis of impact of different weather events in
  the USA based on the NOAA Storm Database
...
setwd("D:/AAA_ProgrammingFiles/AAA_Learning/Coursera_DataScience/5_ReproducibleResearch/PeerAssessment2")
```
